...
class FiveCardAND
{
    ...
    //    new List<List<List<int>>>(){new List<List<int>>(){}},
       ...
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,5}}},
       ...
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){2,5}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){3,4}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){3,5}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){4,5}}},
       ...
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,2,5}}, new List<List<int>>(){new List<int>(){1,5,2}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,3,4}}, new List<List<int>>(){new List<int>(){1,4,3}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,3,5}}, new List<List<int>>(){new List<int>(){1,5,3}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,4,5}}, new List<List<int>>(){new List<int>(){1,5,4}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){2,3,4}}, new List<List<int>>(){new List<int>(){2,4,3}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){2,3,5}}, new List<List<int>>(){new List<int>(){2,5,3}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){2,4,5}}, new List<List<int>>(){new List<int>(){2,5,4}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){3,4,5}}, new List<List<int>>(){new List<int>(){3,5,4}}},
       ...
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,2,3,5}}, new List<List<int>>(){new List<int>(){1,3}, new List<int>(){2,5}}, new List<List<int>>(){new List<int>(){1,5,3,2}}},
       ...
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,2,4,5}}, new List<List<int>>(){new List<int>(){1,4}, new List<int>(){2,5}}, new List<List<int>>(){new List<int>(){1,5,4,2}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,2,5,3}}, new List<List<int>>(){new List<int>(){1,5}, new List<int>(){2,3}}, new List<List<int>>(){new List<int>(){1,3,5,2}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,2,5,4}}, new List<List<int>>(){new List<int>(){1,5}, new List<int>(){2,4}}, new List<List<int>>(){new List<int>(){1,4,5,2}}},
       ...
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,3,2,5}}, new List<List<int>>(){new List<int>(){1,2}, new List<int>(){3,5}}, new List<List<int>>(){new List<int>(){1,5,2,3}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,3,4,5}}, new List<List<int>>(){new List<int>(){1,4}, new List<int>(){3,5}}, new List<List<int>>(){new List<int>(){1,5,4,3}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,3,5,4}}, new List<List<int>>(){new List<int>(){1,5}, new List<int>(){3,4}}, new List<List<int>>(){new List<int>(){1,4,5,3}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,4,2,5}}, new List<List<int>>(){new List<int>(){1,2}, new List<int>(){4,5}}, new List<List<int>>(){new List<int>(){1,5,2,4}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,4,3,5}}, new List<List<int>>(){new List<int>(){1,3}, new List<int>(){4,5}}, new List<List<int>>(){new List<int>(){1,5,3,4}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){2,3,4,5}}, new List<List<int>>(){new List<int>(){2,4}, new List<int>(){3,5}}, new List<List<int>>(){new List<int>(){2,5,4,3}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){2,3,5,4}}, new List<List<int>>(){new List<int>(){2,5}, new List<int>(){3,4}}, new List<List<int>>(){new List<int>(){2,4,5,3}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){2,4,3,5}}, new List<List<int>>(){new List<int>(){2,3}, new List<int>(){4,5}}, new List<List<int>>(){new List<int>(){2,5,3,4}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,2,3,4,5}}, new List<List<int>>(){new List<int>(){1,3,5,2,4}}, new List<List<int>>(){new List<int>(){1,4,2,5,3}}, new List<List<int>>(){new List<int>(){1,5,4,3,2}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,2,3,5,4}}, new List<List<int>>(){new List<int>(){1,3,4,2,5}}, new List<List<int>>(){new List<int>(){1,5,2,4,3}}, new List<List<int>>(){new List<int>(){1,4,5,3,2}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,2,4,3,5}}, new List<List<int>>(){new List<int>(){1,4,5,2,3}}, new List<List<int>>(){new List<int>(){1,3,2,5,4}}, new List<List<int>>(){new List<int>(){1,5,3,4,2}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,2,4,5,3}}, new List<List<int>>(){new List<int>(){1,4,3,2,5}}, new List<List<int>>(){new List<int>(){1,5,2,3,4}}, new List<List<int>>(){new List<int>(){1,3,5,4,2}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,2,5,3,4}}, new List<List<int>>(){new List<int>(){1,5,4,2,3}}, new List<List<int>>(){new List<int>(){1,3,2,4,5}}, new List<List<int>>(){new List<int>(){1,4,3,5,2}}},
       new List<List<List<int>>>(){new List<List<int>>(){}, new List<List<int>>(){new List<int>(){1,2,5,4,3}}, new List<List<int>>(){new List<int>(){1,5,3,2,4}}, new List<List<int>>(){new List<int>(){1,4,2,3,5}}, new List<List<int>>(){new List<int>(){1,3,4,5,2}}},
    };
    ...
    public static readonly List<string> SHUFFLES_CAPTION = new List<string>()
    {
        ...
        "shuf {id, (1 2 3 5), (1 3)(2 5), (1 5 3 2)}",
        "shuf {id, (1 2 4 3), (1 4)(2 3), (1 3 4 2)}",
        "shuf {id, (1 2 4 5), (1 4)(2 5), (1 5 4 2)}",
        "shuf {id, (1 2 5 3), (1 5)(2 3), (1 3 5 2)}",
        "shuf {id, (1 2 5 4), (1 5)(2 4), (1 4 5 2)}",
        "shuf {id, (1 3 2 4), (1 2)(3 4), (1 4 2 3)}",
        "shuf {id, (1 3 2 5), (1 2)(3 5), (1 5 2 3)}",
        "shuf {id, (1 3 4 5), (1 4)(3 5), (1 5 4 3)}",
        "shuf {id, (1 3 5 4), (1 5)(3 4), (1 4 5 3)}",
        "shuf {id, (1 4 2 5), (1 2)(4 5), (1 5 2 4)}",
        "shuf {id, (1 4 3 5), (1 3)(4 5), (1 5 3 4)}",
        "shuf {id, (2 3 4 5), (2 4)(3 5), (2 5 4 3)}",
        "shuf {id, (2 3 5 4), (2 5)(3 4), (2 4 5 3)}",
        "shuf {id, (2 4 3 5), (2 3)(4 5), (2 5 3 4)}",
        "shuf {id, (1 2 3 4 5), (1 3 5 2 4), (1 4 2 5 3), (1 5 4 3 2)}",
        "shuf {id, (1 2 3 5 4), (1 3 4 2 5), (1 5 2 4 3), (1 4 5 3 2)}",
        "shuf {id, (1 2 4 3 5), (1 4 5 2 3), (1 3 2 5 4), (1 5 3 4 2)}",
        "shuf {id, (1 2 4 5 3), (1 4 3 2 5), (1 5 2 3 4), (1 3 5 4 2)}",
        "shuf {id, (1 2 5 3 4), (1 5 4 2 3), (1 3 2 4 5), (1 4 3 5 2)}",
        "shuf {id, (1 2 5 4 3), (1 5 3 2 4), (1 4 2 3 5), (1 3 4 5 2)}",
    };
    ...
    public static State getStartState()
    {
        ...
        x00.symbols[2] = Symbols.Heart;
        x00.symbols[3] = Symbols.Club;
        x00.symbols[4] = Symbols.Heart;
        ...
        x01.symbols[3] = Symbols.Heart;
        x01.symbols[4] = Symbols.Club;
        x01.X01 = new Fraction(1);
        CardRow x10 = new CardRow();
        x10.symbols[0] = Symbols.Heart;
        x10.symbols[1] = Symbols.Club;
        x10.symbols[2] = Symbols.Heart;
        x10.symbols[3] = Symbols.Club;
        x10.symbols[4] = Symbols.Heart;
        ...
        x11.symbols[3] = Symbols.Heart;
        x11.symbols[4] = Symbols.Club;
    ...
    public static bool isFinalState(State state)
    {
        ...
        List<CardRow> output_0 = state.rows.FindAll(x => x.X00 > new Fraction(0) || x.X01 > new Fraction(0) || x.X10 > new Fraction(0));
        List<CardRow> output_1 = state.rows.FindAll(x => x.X11 > new Fraction(0));
    ...
    public static bool hasBotSequence(State state)
    {
        foreach (var row in state.rows)
        {
            if (row.X00 + row.X01 + row.X10 > new Fraction(0) && row.X11 > new Fraction(0)) return true;
        }
        return false;
    }
